...
so Hammer replaces its default DRC run file with an extra hook.
This is a good example of how Hammer leverages its hook methods to enhance its capabilities. 
